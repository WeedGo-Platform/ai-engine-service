      ...
      <div className="p-4">
        <div className="flex items-center gap-3 max-w-6xl mx-auto">
          ...
          <button
            ...
            className="p-3 rounded-xl bg-gradient-to-br from-purple-700/70 to-pink-700/70 hover:from-purple-600/80 hover:to-pink-600/80 text-yellow-300 hover:text-yellow-200 transition-all disabled:opacity-50 disabled:cursor-not-allowed relative shadow-lg hover:shadow-[0_0_20px_rgba(253,224,71,0.4)] border border-yellow-400/30"
          ...
          <button
            ...
            className={`p-3 rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg border ${
              isRecording 
          ...
          <input
            ...
            disabled={!isModelLoaded}
            className={`flex-1 px-5 py-3 bg-gradient-to-r from-purple-900/60 via-pink-900/50 to-purple-900/60 border-2 border-purple-400/40 rounded-xl text-yellow-100 placeholder-purple-300 focus:outline-none focus:ring-2 focus:ring-yellow-400/50 focus:border-yellow-400/50 transition-all shadow-inner backdrop-blur-sm font-medium`}
          />
          ...
          <button
            ...
            className="px-6 py-3 bg-gradient-to-r from-green-500 via-emerald-500 to-green-400 hover:from-green-400 hover:to-emerald-400 text-purple-950 font-bold rounded-xl transition-all transform hover:scale-105 active:scale-95 shadow-xl hover:shadow-[0_0_30px_rgba(34,197,94,0.5)] disabled:from-purple-700 disabled:to-purple-600 disabled:text-purple-400 disabled:cursor-not-allowed flex items-center gap-2 border-2 border-green-300/50"
          >
            {isSending ? (
              <>
