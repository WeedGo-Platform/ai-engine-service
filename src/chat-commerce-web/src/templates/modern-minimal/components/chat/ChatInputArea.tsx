      ...
      <div className="p-4">
        <div className="flex items-center gap-2 max-w-4xl mx-auto">
          ...
          <button
            ...
            className="p-2.5 rounded-lg hover:bg-slate-100 text-slate-600 hover:text-slate-900 transition-all duration-200 disabled:opacity-30 disabled:cursor-not-allowed"
            title="Templates"
          >
          ...
          <input
            ...
            disabled={!isModelLoaded}
            className={`flex-1 px-4 py-2.5 bg-white border border-slate-300 rounded-lg text-slate-900 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:border-slate-400 transition-all duration-200 font-normal`}
          />
          ...
          <button
            ...
            className="px-5 py-2.5 bg-slate-800 hover:bg-slate-700 text-white font-medium rounded-lg transition-all duration-200 disabled:bg-slate-200 disabled:text-slate-500 disabled:cursor-not-allowed flex items-center gap-2"
          >
            {isSending ? (
              <>
        ...
        {/* Templates Dropdown */}
        {showTemplates && (
          <div className="absolute bottom-20 left-4 right-4 max-w-4xl mx-auto bg-white border border-slate-300 rounded-lg shadow-xl p-4 z-50">
            ...
            <div className="grid grid-cols-2 gap-2 max-h-60 overflow-y-auto">
              {CONVERSATION_TEMPLATES.map(template => (
                <button
                  ...
                  className="text-left p-3 bg-slate-50 hover:bg-slate-100 rounded-lg transition-all group border border-slate-200"
                >
                  <div className="flex items-start gap-2">
                    <span className="text-sm">{template.icon}</span>
                    <div className="flex-1">
                      <div className="text-xs font-semibold text-slate-800 group-hover:text-slate-900">{template.title}</div>
