...
/**
 * Creates a product details message for the chat
 * @param product - The product to display
 * @returns A formatted message object for chat display
 */
export function createProductDetailsMessage(product: any) {
  return {
...
/**
 * Checks if a message is a product details message
 * @param content - The message content to check
 * @returns true if this is a product details message
 */
export function isProductDetailsMessage(content: any): boolean {
  return content && 
