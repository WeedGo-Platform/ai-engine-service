...
const TextInputWindow: React.FC<TextInputWindowProps> = ({
  ...
  return (
    <input
      ...
      disabled={disabled}
      className="flex-1 px-5 py-3.5 bg-white border border-gray-200 rounded-xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:border-transparent  shadow-sm"
    />
  );
};
