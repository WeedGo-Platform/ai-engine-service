...
const ChatHeader: React.FC<ChatHeaderProps> = ({
  ...
  return (
    <div className="bg-white backdrop-blur-lg border-b border-gray-200 px-8 py-3">
      <div className="flex items-center justify-between">
        <div className={`flex items-center gap-3 ${isPanelOpen ? 'ml-16' : 'ml-16'}`}>
          <div className={`flex items-center gap-2 px-3 py-1.5 rounded-md   ${
            ...
            <div className={`w-1.5 h-1.5 rounded-full   ${
              isModelLoaded ? 'bg-emerald-400 shadow-[0_0_6px_rgba(52,211,153,0.6)]' : 'bg-gray-400'
            }`}></div>
          ...
          {isSpeaking && (
            <div className="flex items-center gap-1.5 px-2 py-1 bg-emerald-50 rounded-md border border-emerald-200">
              <div className="flex gap-0.5">
                <span className="w-0.5 h-3 bg-emerald-400 rounded-full animate-[wave_1s__infinite]"></span>
                <span className="w-0.5 h-3 bg-emerald-400 rounded-full animate-[wave_1s__infinite_0.1s]"></span>
                <span className="w-0.5 h-3 bg-emerald-400 rounded-full animate-[wave_1s__infinite_0.2s]"></span>
              </div>
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className={`p-2 rounded-lg ${windowState === 'floating' ? 'bg-blue-500 text-white' : 'hover:bg-gray-100 text-gray-600 hover:text-blue-700'}  `}
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-gray-100 text-gray-600 hover:text-blue-700   disabled:opacity-30 disabled:cursor-not-allowed"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="px-2.5 py-1 bg-blue-600 text-white rounded-md" title={`Session ID: ${sessionId}`}>
