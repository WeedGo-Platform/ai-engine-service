          ...
          <div className="space-y-4">
            {showVoiceEnrollment ? (
              <VoiceEnrollment
                ...
                className="modern-minimal-voice-enrollment"
                buttonClassName="bg-black text-white hover:bg-gray-800 border-none font-mono uppercase tracking-wide transition-colors"
              />
            ) : (
              <VoiceLogin
