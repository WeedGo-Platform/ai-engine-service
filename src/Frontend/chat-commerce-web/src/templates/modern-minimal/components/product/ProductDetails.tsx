...
const ProductDetails: React.FC<ProductDetailsProps> = ({
  ...
  const getStrainTypeColor = (type?: string) => {
    switch (type?.toLowerCase()) {
      ...
      case 'cbd': return 'border-amber-500 text-amber-600 bg-amber-50';
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-4">
              ...
              <button
                ...
                className={`flex-1 py-3 px-6 rounded-sm font-medium transition-all flex items-center justify-center gap-2 ${
                  product.in_stock
