            ...
            {formData.sms.provider === 'twilio' && (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border-gray-300 shadow-sm focus:border-accent-500 focus:ring-accent-500 pr-10"
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-gray-500">Used for OTP verification</p>
                </div>
