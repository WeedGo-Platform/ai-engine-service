              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-gray-50">
                {messages.map((message) => (
                  <div key={message.id}>
                    ...
                    {/* Timestamp */}
                    <div className={`mt-1.5 px-2 ${message.role === 'user' ? 'text-right' : 'text-left'}`}>
                      <span className="text-xs italic text-gray-400 flex items-center gap-1 ${message.role === 'user' ? 'justify-end' : 'justify-start'}">
