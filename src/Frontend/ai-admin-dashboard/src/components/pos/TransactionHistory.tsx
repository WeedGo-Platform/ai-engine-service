...
const RefundModal: React.FC<RefundModalProps> = ({ transaction, onClose, onRefund }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black dark:bg-gray-900 bg-opacity-50 dark:bg-opacity-70 p-0 sm:p-4">
      <div className="bg-white dark:bg-gray-800 h-full sm:h-auto sm:rounded-lg border-0 sm:border border-gray-200 dark:border-gray-700 w-full sm:max-w-2xl max-h-full sm:max-h-[90vh] overflow-y-auto">
        <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800 z-10">
          <div className="flex items-center justify-between">
            <h2 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">Process Refund</h2>
            <button onClick={onClose} className="p-2 -mr-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg">
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-2 sm:gap-4">
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-4 py-2.5 sm:py-2 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-medium active:scale-95 transition-all touch-manipulation"
            >
              Cancel
            </button>
            <button
              ...
              className="w-full sm:w-auto px-4 py-2.5 sm:py-2 bg-danger-500 dark:bg-red-600 text-white rounded-lg hover:bg-danger-600 dark:hover:bg-red-500 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 font-semibold active:scale-95 transition-all touch-manipulation"
            >
              {processing ? (
                <>
