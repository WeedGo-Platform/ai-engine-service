    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0">
        <div>
          ...
          <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mt-1">Managing orders for {currentStore.name}</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <Clock className="h-6 w-6 sm:h-8 sm:w-8 text-warning-600 dark:text-warning-400" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <Package className="h-6 w-6 sm:h-8 sm:w-8 text-accent-600 dark:text-accent-400" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">Today's Revenue</p>
            ...
            <CreditCard className="h-6 w-6 sm:h-8 sm:w-8 text-primary-600 dark:text-primary-400" />
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            ...
            <CheckCircle className="h-6 w-6 sm:h-8 sm:w-8 text-gray-600 dark:text-gray-400" />
          </div>
        </div>
      </div>
      ...
      {/* Order Details Modal */}
      {selectedOrder && (
        <div className="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-0 sm:p-4 lg:p-6 z-50">
          <div className="bg-white dark:bg-gray-800 h-full sm:h-auto sm:rounded-lg border-0 sm:border border-gray-200 dark:border-gray-700 sm:max-w-4xl w-full max-h-full sm:max-h-[90vh] overflow-y-auto flex flex-col">
            <div className="p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0 sticky top-0 bg-white dark:bg-gray-800 z-10">
              <div className="flex justify-between items-center">
                <h2 className="text-base sm:text-xl font-bold text-gray-900 dark:text-white truncate pr-4">Order: {selectedOrder.order_number}</h2>
                <button
                  onClick={() => setSelectedOrder(null)}
                  className="p-2 -mr-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors flex-shrink-0"
            ...
            <div className="p-4 sm:p-6 flex-1 overflow-y-auto">
              ...
              <div className="mb-4 sm:mb-6">
                <h3 className="font-semibold mb-2 sm:mb-3 text-gray-900 dark:text-white">Order Items</h3>
                <div className="overflow-x-auto -mx-4 sm:mx-0">
                  <div className="inline-block min-w-full align-middle px-4 sm:px-0">
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                      <thead className="bg-gray-50 dark:bg-gray-700">
                        <tr>
                          <th className="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Product</th>
                          <th className="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Qty</th>
                          <th className="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Price</th>
                          <th className="px-3 sm:px-4 py-2 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase">Total</th>
                        </tr>
                      </thead>
                      <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              {selectedOrder.special_instructions && (
                <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-warning-50 dark:bg-warning-900/30 rounded border border-warning-200 dark:border-warning-800">
                  <p className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white">Special Instructions:</p>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">{selectedOrder.special_instructions}</p>
                </div>
              )}
            </div>
          </div>
