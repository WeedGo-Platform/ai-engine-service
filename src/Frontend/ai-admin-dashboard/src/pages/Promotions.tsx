                    ...
                    <tr key={promo.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <div className="ml-3">
                            <div className="text-sm font-medium text-gray-900 dark:text-white">{promo.name}</div>
                            <div className="text-sm text-gray-500 dark:text-gray-400">{promo.type}</div>
                          </div>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        {promo.code ? (
                          <div className="flex items-center">
                            <code className="text-sm bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-200 px-2 py-1 rounded">{promo.code}</code>
                            <button
                              onClick={() => {
