  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6 px-4 sm:px-0">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 transition-colors">
        ...
        <p className="mt-2 text-sm sm:text-base text-gray-600 dark:text-gray-300">{t('catalog:descriptions.mainVirtual')}</p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                ...
                {selectedFile && (
                  <span className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 truncate max-w-full">{selectedFile.name}</span>
                )}
              </div>
            </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 transition-colors">
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 lg:gap-6">
          ...
          <button
            onClick={exportToCSV}
            className="w-full sm:w-auto px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-600 rounded-lg transition-all active:scale-95 touch-manipulation"
          >
