          ...
          <div>
            <button
              ...
              className={`group relative w-full flex justify-center py-3 px-4 border border-transparent text-sm font-medium rounded-md text-white ${
                loading || (Object.keys(errors).length > 0 && Object.keys(touched).length > 0)
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path d="M17.05 20.28c-.98.95-2.05.88-3.08.36-1.09-.55-2.08-.56-3.25 0-1.44.68-2.19.53-3.04-.36C3.79 15.25 4.39 7.59 8.9 7.36c1.17.05 1.99.63 2.67.65.99-.18 1.94-.72 3.01-.65 1.27.08 2.22.5 2.85 1.26-2.61 1.56-1.99 4.98.35 5.94-.38 1.01-.87 2.01-1.73 3.72zm-4.13-14.09c-.24 1.88-1.75 3.21-3.5 3.04-.21-1.67 1.46-3.39 3.5-3.04z"/>
              </svg>
