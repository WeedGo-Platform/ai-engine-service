...
up: ## Start all services and load data
	...
	DB_HOST=localhost DB_PORT=5434 DB_NAME=ai_engine DB_USER=weedgo DB_PASSWORD=your_password_here MILVUS_HOST=localhost MILVUS_PORT=19531 REDIS_HOST=localhost REDIS_PORT=6381 python3 scripts/load_complete_data.py
